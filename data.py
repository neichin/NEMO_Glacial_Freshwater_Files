...
valuesIS1990= {'ar':-39, 'ne':-36, 'ais': -39, 'w': -15, 'sha':-35, 'van':-5, 'tot':-62,
'mu':-29, 'por':-14,'ade':-10,'mer':-4,'nin':0,'coo':0,'ren':-5, 'dry':-5,'ris':-28,
'sul':-28,'lan':-5,'getz':-72,'cd':-37,'thw':-30,'pig':-46,'cosg':-12, 'abb':-58,'ven':-7,
'geo':-114,'wor':-7,'lbc':0,'fris':-50,'brl':-26,'jf':-24}  ##Como no puedo poner runoff negativo a lBC, los -8Gt de parte negativa se la resto a FRIS
...
upscaling1990={'westIndian':-40,'eastIndian':-82,'rossSea':-12,'amundsen':-87,'bellingshausen':-25,'weddell':-13}

upscalingIB={'westIndian':49,'eastIndian':93,'rossSea':14,'amundsen':34,'bellingshausen':10,'weddell':16}


#Iceshelves from Depoorter definition of segments, every two values is a lon,lat pair definiing a segment
#(ex:8 values means (lon1,lat1,lon2,lat2,lon3,lat3,lon4,lat4) there are two segments between 1 and 2, and between 3 and 4)
